    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 py-16">
        ...
        <header className="mb-16 text-center">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Seguridad Ofensiva</h1>
        ...
        {/* Methodology */}
        <section className="mb-16">
          <h2 className="mb-8 text-center text-2xl font-bold tracking-tight">Metodología</h2>
          <div className="grid gap-4 sm:grid-cols-4">
            {methodology.map((phase, i) => (
              <div key={phase.step} className="relative">
                {/* Connector arrow (hidden on first item and mobile) */}
                {i > 0 && (
                  <div className="absolute top-1/2 -left-2.5 hidden -translate-y-1/2 text-gray-300 sm:block dark:text-gray-700">
                ...
                <div className="rounded-xl border border-gray-200 p-5 transition-all duration-300 hover:border-red-500/30 hover:shadow-lg hover:shadow-red-500/5 dark:border-gray-800 dark:hover:border-red-500/30 dark:hover:shadow-red-500/10">
