---
title: 'De alertas a acción: respuesta automática a SSH brute force con SOAR (Shuffle + Wazuh)'
date: '2025-11-17T00:00:00'
lastmod: '2025-11-17T00:00:00'
summary: 'De la alerta en Wazuh al bloqueo automático en iptables con Shuffle SOAR en menos de 15 s. Arquitectura, código completo, pruebas y troubleshooting real.'
tags:
  [
    'soar',
    'shuffle',
...
> **Resumen ejecutivo:** En este tutorial construyo una respuesta automática a ataques SSH brute force que va desde la alerta en **Wazuh** hasta el **bloqueo de IP con iptables** orquestado por **Shuffle SOAR**. El objetivo es que, en **menos de 15 segundos**, el sistema pase de _detectar_ a _mitigar_ sin intervención humana. Comparto arquitectura, código completo, decisiones de diseño, pruebas end‑to‑end y el troubleshooting real que me encontré.

## 0. Contexto y alcance

Este post asume que ya tenés un laboratorio con **Wazuh** y **Shuffle** funcionando. Si te perdiste la primera parte, [acá está el post de integración Wazuh-Shuffle](https://cobalto-sec.tech/blog/2025-11-12-de-cero-a-soar-integrando-wazuh-con-shuffle) donde cubrimos el setup base.
...
> **Tip:** Si es tu primera vez con Shuffle, empezá con un _hello webhook_ simple (un flujo que solo recibe y registra el payload). Validás red, puertos y formato antes de meter lógica compleja.
...
- Un **API** nos da un punto de control con _inputs_ validados y capacidad de auditoría
...
![Ejecución exitosa en Shuffle](/images/blog/2025-11-17-respuesta-automatica-ssh-brute-force-soar/21_shuffle_execution_success.png)
_Caption: IP extraída correctamente, acción tomada_
...
![Configuración integración Wazuh-Shuffle](/images/blog/2025-11-17-respuesta-automatica-ssh-brute-force-soar/09_wazuh_ossec_conf.png)
_Caption: Integración configurada con level 10 - solo alertas importantes_
...
![Logs de integración Wazuh](/images/blog/2025-11-17-respuesta-automatica-ssh-brute-force-soar/23_wazuh_integration_logs.png)
...
_Caption: IP 192.168.0.121 bloqueada automáticamente_
...
![Ejecución en Shuffle](/images/blog/2025-11-17-respuesta-automatica-ssh-brute-force-soar/13_shuffle_wazuh_execution.png)
...
**Repositorio GitHub:** _(próximamente - estoy organizando el código)_
...
**Próximo paso:** Completar el Bloque 2 con notificaciones, FIM response y enriquecimiento de contexto. Después, agregar **inteligencia** (threat intel + ML) para decidir _mejor_ a quién bloquear, no solo _más rápido_.
