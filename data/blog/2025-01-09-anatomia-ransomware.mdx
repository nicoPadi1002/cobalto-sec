---
title: 'Anatomía de un Ataque Ransomware: Simulación Controlada en Honeypot'
date: '2026-01-09T00:00:00'
lastmod: '2026-01-09T00:00:00'
summary: 'Documentación completa de un ataque ransomware simulado: 8 técnicas MITRE ATT&CK capturadas en 15 minutos con análisis de cada fase del kill chain'
tags:
  [
    'ransomware',
    'honeypot',
...
2. **Evaluar la efectividad** de mis mecanismos de detección
3. **Identificar indicadores tempranos** que permitan mitigación proactiva
...
- ✅ Descarga de script con extensión `.sh` detectada
- ⏱️ Tiempo de detección: &lt;5 segundos
...
- ✅ Ejecución de script desde `/tmp` capturada
- ✅ Conexión POST al C2 server registrada
...
- ✅ Modificación de `.bashrc` detectada
- ✅ Cambio en crontab registrado
...
**Análisis crítico:**
El atacante **FALLÓ** en borrar evidencia porque:
...
- Modificación de `.bashrc` sin razón operacional
...
- Modificación de `/var/log/*` borra rastros
- **Pero si los logs ya están en SIEM externo, no hay forma de eliminarlos**
